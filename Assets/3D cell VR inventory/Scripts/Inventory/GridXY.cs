...
namespace Inventory
{
    ...
    public class GridXY
    {
        ...
        public void PlaceItem(Transform _item, InventoryCellObject cell, AxisDirections CellOrientationAxis = default)
        {
            ...
            itemdata.item.transform.localRotation = Quaternion.Euler(ItemData.CalculateDirection(CellOrientationAxis));
